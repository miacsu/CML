...
multi-modal PGCN based cross-modal feature fusion (SNP and MRI)
...
from models.crossModalFeatureFusionPGCN import CMFFPGCN
...
def main(opt, exp, seed):
    ...
    for fold in range(n_folds):
        ...
        model = CMFFPGCN(features1.shape[1], features2.shape[1], 300, 300, opt.num_classes,
                       opt.dropout, hgc=opt.hgc, lg=opt.lg)
