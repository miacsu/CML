...
class CMFFPGCN(torch.nn.Module):
    def __init__(self, x1_dim, x2_dim, CMFF_input_dim, CMFF_output_dim, num_classes, dropout, hgc, lg):
        super(CMFFPGCN, self).__init__()
        ...
        for i in range(lg):
            in_channels = CMFF_output_dim if i == 0 else hidden[i-1]
