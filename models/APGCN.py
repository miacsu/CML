...
class APGCN(torch.nn.Module):
    def __init__(self, input_dim, num_classes, dropout, edgenet_input_dim, edge_dropout, hgc, lg, K=3):
        ...
        self.edge_net = metaGraph(input_dim=edgenet_input_dim//2, dropout=dropout)
        self.model_init()
