...
and concat (non-meta and meta data)
...
from models.crossModalFeatureFusionConcatMLP import CMFFConcat
...
def main(opt, exp, seed):
    ...
    for fold in range(n_folds):
        ...
        model = CMFFConcat(features1.shape[1], features2.shape[1], features3.shape[1], 300, 300, opt.num_classes, opt.dropout)
