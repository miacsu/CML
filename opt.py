...
class OptInit():
    def __init__(self):
        parser = argparse.ArgumentParser(description='PyTorch implementation of CML')
        ...
        parser.add_argument('--num_exp', default=10, type=int, help='number of exp')
        parser.add_argument('--num_fold', default=10, type=int, help='number of fold in one exp')
        ...
        parser.add_argument('--task', type=str, default='HC_MCI', help='task of class')
        parser.add_argument('--ckpt_path', type=str, default='./save_models/HC_MCI', help='checkpoint path to save trained models')
