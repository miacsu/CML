...
multi-modal MLP based concat (SNP and MRI)
...
from models.concatMLP import concatMLP
...
def main(opt, exp, seed):
    ...
    for fold in range(n_folds):
        ...
        model = concatMLP(features1.shape[1], features2.shape[1], opt.num_classes, opt.dropout)
