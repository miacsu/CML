...
multi-modal MLP based concat (SNP, MRI and meta data)
...
from models.concatConcatMLP import concatconcatMLP
...
def main(opt, exp, seed):
    ...
    for fold in range(n_folds):
        ...
        model = concatconcatMLP(features1.shape[1], features2.shape[1], features3.shape[1], opt.num_classes, opt.dropout)
